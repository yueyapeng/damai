package com.damai.wine.api.service.request.order;
...
@Data
public class WineOrderQueryRequest implements Serializable {

    private static final long serialVersionUID = 2580454466365110788L;
